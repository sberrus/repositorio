						...
						<Row>
							<Col md={6} className="m-auto">
								...
								<div className={`${styled.aboutHistory} text-center fw-light mb-5`}>
									...
									<p>
										Durante la pandemia un amigo me dio un consejo que fue el que en realidad me inicio en
										este mundillo.
									</p>
									...
									<p>
										...
										<small className="text-danger"> dolorosa </small>tengo que admitir, senda del
										desarrollador.
									</p>
									<p>
										Han pasado varios meses desde entonces y con ellos he adquirido un set amplio de
										habilidades y manejo de herramientas de todo tipo, academica y profesionalmente.
									</p>
									<p>A lo largo de estos años he desarrollado habilidades en las siguientes herramientas:</p>
								</div>
							</Col>
						</Row>
					</Container>
